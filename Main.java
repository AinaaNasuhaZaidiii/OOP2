...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numTutors; i++) {
            ...
            Tutor tutor = new Tutor(tutorName, tutorIC, tutorAddress, tutorQualification, tutorExperience,
                    tutorDateJoined, tutorYearsInCenter);
        ...
        for (int i = 0; i < numStudents; i++) {
            ...
            Student student = new Student(studentName, studentIC, studentAddress, studentYear, studentSchoolName,
                    scores);
        ...
        List<String> tutorName = tuitionCenter.getTutorNameList();
        List<String> JoinDate = tuitionCenter.getJoinDate();

        for (int i = 0; i < tutorName.size(); i++) {
            System.out.println("");
            System.out.println(tutorName.get(i) + ":");
            System.out.println(backgrounds.get(i) + ":");
            System.out.println(JoinDate.get(i) + ":");
            System.out.println("");
        }
