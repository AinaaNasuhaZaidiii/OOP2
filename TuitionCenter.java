...
public class TuitionCenter {
    ...
    public List<String> getTutorNameList() {
        List<String> tutorName = new ArrayList<>();
        for (Tutor tutor : tutors) {
            tutorName.add(tutor.getName());
        }
        return tutorName;
    }

    public List<String> getJoinDate() {
        List<String> joinDate = new ArrayList<>();
        for (Tutor tutor : tutors) {
            joinDate.add(tutor.getDateJoined());
        }
        return joinDate;
    }
